...
Currently there are 14 plugins available. They are:
    1.  check_gls.pl
    2.  check_ls.pl
    3.  check_pinger.pl
    4.  check_snmp.pl
    5.  check_throughput.pl
    6.  check_owdelay.pl
    7.  check_traceroute.pl

    New checks, that are still undocumented are:
    8.  check_delay.pl
    9.  check_loss.pl
    10. check_path_mtu.pl
    11. check_retransmits.pl
    12. check_sls.pl
    13. check_throughput_owdelay.pl
    14. check_toolkit.pl

    Deprecated checks in the documentation are:
    1.  check_hls.pl
    2.  check_perfSONAR.pl
    3.  check_ps_version.pl
    4.  check_topology.pl
